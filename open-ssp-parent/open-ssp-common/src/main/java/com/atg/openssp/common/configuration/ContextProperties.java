...
public enum ContextProperties {
	...
	@RuntimeMeta(type = Scope.GLOBAL)
	DATA_PROVIDER_PATH("data-provider-path"),
	...
	/**
	 * real-time auction logging feed
	 */
	@RuntimeMeta(type = Scope.GLOBAL)
	AUCTION_LOGGING_PROJECT("real-time-auction-logging-project"),

    @RuntimeMeta(type = Scope.GLOBAL)
	AUCTION_LOGGING_TOPIC("real-time-auction-logging-topic");

	//###########################################################

	private String value;

	ContextProperties(final String value) {
		this.value = value;
	}

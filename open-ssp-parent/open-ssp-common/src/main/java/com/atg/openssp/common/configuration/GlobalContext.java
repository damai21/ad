...
public class GlobalContext extends Context {
	...
	// auction logs realtime feed
	private static String auctionLoggingProject;
	private static String auctionLoggingTopic;
	...
	public static void refreshContext() {
		...
		auctionLoggingProject = ContextCache.instance.get(ContextProperties.AUCTION_LOGGING_PROJECT);
		auctionLoggingTopic = ContextCache.instance.get(ContextProperties.AUCTION_LOGGING_TOPIC);
	}
	...
	public static String getAuctionLoggingProject() {
		return auctionLoggingProject;
	}

	public static String getAuctionLoggingTopic() {
		return auctionLoggingTopic;
	}
}

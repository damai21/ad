...
//TODO: BKS
	...
	public static class Builder {
		...
		public Builder setSearch(final String search){
	...
	public String toString() {
		return String.format("Site [id=%s, name=%s, domain=%s, cat=%s, pagecat=%s, sectioncat=%s, page=%s, search=%s,keywords=%s, ext=%s]", id, name, domain, cat, pagecat, sectioncat, page,search,keywords, ext);
	}

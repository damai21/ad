...
public class BidRequestBuilderTest {
	...
	public void testBidRequest() {
		...
		// Impression
		Assert.assertEquals(1, bidRequestVideo.getAllImp().size());
		Assert.assertNotNull(bidRequestVideo.getAllImp().get(0));
		Assert.assertEquals("45", bidRequestVideo.getAllImp().get(0).getId());
		// Impression -> Video
		Assert.assertEquals(400, bidRequestVideo.getAllImp().get(0).getVideo().getH());
		Assert.assertEquals(600, bidRequestVideo.getAllImp().get(0).getVideo().getW());
		Assert.assertEquals(100, bidRequestVideo.getAllImp().get(0).getVideo().getMaxduration());
		Assert.assertEquals(30, bidRequestVideo.getAllImp().get(0).getVideo().getMinduration());
		Assert.assertEquals(-1, bidRequestVideo.getAllImp().get(0).getVideo().getStartdelay());
		//TODO: BKS
		Assert.assertEquals(1, bidRequestVideo.getAllImp().get(0).getVideo().getProtocols().size());
		Assert.assertEquals(2, bidRequestVideo.getAllImp().get(0).getVideo().getProtocols().get(0).getValue());
		Assert.assertEquals(1, bidRequestVideo.getAllImp().get(0).getVideo().getMimes().size());
		Assert.assertEquals("application/x-shockwave-flash", bidRequestVideo.getAllImp().get(0).getVideo().getMimes().get(0));

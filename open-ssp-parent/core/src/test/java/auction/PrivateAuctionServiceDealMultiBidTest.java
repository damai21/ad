...
public class PrivateAuctionServiceDealMultiBidTest {
	...
	public final void testMultiBidDealWins() {
		...
		// bidrequest1
		final BidRequest bidRequest1 = RequestResponseHelper.createRequest(requestId1, impFloor, dealFloor1, currency, deal_id_1, 1).build();
		// bidrequest1
		final BidRequest bidRequest2 = RequestResponseHelper.createRequest(requestId2, impFloor, dealFloor2, currency, deal_id_2, 1).build();
	...
	public final void testMultiBidMultiImpressionDealWins() {
		...
		// bidrequest1
		final BidRequest bidRequest1 = RequestResponseHelper.createRequest(requestId1, impFloor, new float[]{dealFloor1a, dealFloor1b, dealFloor1c}, currency, deal_id_1, 1).build();

		// bidrequest1
		final BidRequest bidRequest2 = RequestResponseHelper.createRequest(requestId2, impFloor, new float[]{dealFloor2a, dealFloor2b, dealFloor2c}, currency, deal_id_2, 1).build();

...
//        dd.setUa(masterValues.getBrowserUserAgentString());
        ...
        //TODO
        dd.setUa("Mozilla/5.0 (Linux; Android 5.0.2; SAMSUNG SM-A500FU Build/LRX22G) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/3.3 Chrome/38.0.2125.102 Mobile Safari/537.36");

        log.warn(String.valueOf("this is your master" +masterValues));
        ...
        log.warn(String.valueOf(bidRequest));
        return bidRequest;
    }
